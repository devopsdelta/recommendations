...
api = Api(app,
          ...
          description='This is a sample server Recommendation server.'#,doc='/apidocs/'
          )
...
recommendation_model = api.model('Recommendation', {
    ...
    'rec_prod_id': fields.Integer(required=True,
...
class RecommendationCollection(Resource):
    ...
    @ns.param('type', 'List Recommendation by Recommendation Type')
